...
namespace Utility.Excel
{
    public class ReadCellsValue
    {
        ...
        /// <returns></returns>
        public string ReadStringCell(string bookName, string sheetName, string ext, string[] cells)
        {
        ...
        public Nullable<DateTime> ReadDateCell(string bookName, string sheetName, string ext, string[] cells)
        {
            ...
            using (FileStream file = new FileStream(bookName, FileMode.Open, FileAccess.Read))
            {
                ...
                if (ext == ".xlsx")
                {
                    ...
                    cellValue = sheet.GetRow(Convert.ToInt32(cells[0]) - 1).GetCell(Convert.ToInt32(cells[1]) - 1).DateCellValue;
                    return cellValue;
        ...
        /// <summary>
        /// 读取固定列区域内的数据，获取一个单元格数据,并以此单元格数据循环读取中的起始单元格
        /// </summary>
        /// <param name="bookName"></param>
        /// <param name="sheetName"></param>
        /// <param name="ext"></param>
        ...
        /// <returns></returns>
        public string ReadFixRegion(string bookName, string sheetName, string ext, int rowNo, int columnNo)
        {
