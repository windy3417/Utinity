...
namespace debugUtility.UI.Print
{
    public partial class FrmMutiplePagePrinting : Form
    {
        public FrmMutiplePagePrinting()
        {
            InitializeComponent();
        }
        ...
        private void displayFonts_Click(object sender, EventArgs e)
        {
